...
public class DBUtils{
    ...
    public static void signUpUser(ActionEvent event, String username, String password, String gender){
        ...
        try {
            //connection= DriverManager.getConnection("jdbc:mysql://localhost:3306/javafx_login", "root", "batman@20");
            connection= DriverManager.getConnection("jdbc:mysql://localhost:3307/users");
